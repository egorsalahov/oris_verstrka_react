...
const CardInfoRightBlock = () => {
          ...
          <div className="TVTourCardActionPrice">
            ...
            <div className="TVTourCardInstantConfirmation">
              <div
                ...
                <span className="TVInstantConfirmationContent TVFontSize-M TVFontWeightSize-M">
  ...
  // ✅ Форматируем цену из tours.json
  const formattedPrice = tour.price.toLocaleString('ru-RU');
